         ...
         <nav id="nav-wrap">
          ...
          <a className="mobile-btn" href="#" title="Hide navigation">Hide navigation</a>
            <ul id="nav" className="nav">
               ...
               <li><a className="smoothscroll atb-modern-b" data-text="contact" href="#contact"><span>c</span><span>o</span><span>n</span><span>t</span><span>a</span><span>c</span><span>t</span></a></li>
            </ul>
         </nav>
